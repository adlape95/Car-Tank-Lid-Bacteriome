...
This is a repository of the code used for data analysis in "The car tank lid bacteriome: a reservoir of bacteria with potential in bioremediation of fuel", by Vidal-Verdú *et al.* (2022).
